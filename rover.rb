...
class Rover
  ...
  def read_instruction(plateau_size, start_position, move)
...
puts "Please enter Rover1's start position (x=#{x_min} to x=#{x_max}, y=#{y_min} to y=#{y_max}, start direction = N/E/S/W):"
...
puts "Please enter Rover2's start position (x=#{x_min} to x=#{x_max}, y=#{y_min} to y=#{y_max}, start direction = N/E/S/W):"
